...
function createEmployeeRecord(testEmployee){
    const [firstName, familyName, title, payPerHour] = testEmployee
    return {
        firstName,
        familyName,
        title,
...
function findEmployeeByFirstName(collection, nameString) {
    return collection.find((employee) => employee.firstName === nameString);
}
